...
class PostgreSQLHandler:
    ...
    def user_exist(self, email):
        self.cursor.execute(self.get_query("user_exists"), (email,))
    ...
    def select_user(self, email):
        self.cursor.execute(self.get_query("select_user"), (email,))
    ...
    def delete_user(self, email):
        self.cursor.execute(self.get_query("delete_user"), (email,))
        self.connection.commit()
